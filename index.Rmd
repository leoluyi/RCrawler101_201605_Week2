...
- It is IMPORTANT when wrapping your crawler into a function because you don't want your function fail without any outcome.
...
### 結構化資料
+ json, jsonp: PChome, 紫外線即時監測資料 (`jsonlite`)
...
- Use `iconv()`, `Encoding<-` and `Sys.setlocale()` in Windows
...
```{r}
students <- read_html("resources/data/demo.html") %>% 
