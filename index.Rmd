...
- `rvest::html_table`  
(`rvest::html_table` is temperarily not working with unicode data on Windows.)
...
tables2 <- res_text %>% XML::readHTMLTable(encoding = "UTF-8")
...
# Combind list of dataframes with loop (not recommended)
