...
subtitle: "Week 2"
author: "Leo Lu<p />(This material is modified from Mansun Kuo)"
date: '`r Sys.Date()`'
ratio: 16x10
output: 
  rmdshower::shower:
...
<p class="white">
`r Sys.Date()`<br><p style='color:royalblue'>[Leo Lu](https://tw.linkedin.com/pub/mansun-kuo/82/3b4/344)</p>
</p>
...
# Install Packages (if you don't have those packages yet)
...
<img src="resources/img/hello_rstudio.png" alt="rstudio" style="max-width: 800px;">
...
Run current line/selection  | <kbd>Ctrl</kbd>+<kbd>Enter</kbd> | <kbd>Cmd</kbd>+<kbd>Enter</kbd> |
Comment/uncomment current line/selection | <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>C</kbd> | <kbd>Cmd</kbd>+<kbd>Shift</kbd>+<kbd>C</kbd> |
Reindent lines              | <kbd>Ctrl</kbd>+<kbd>I</kbd> | <kbd>Cmd</kbd>+<kbd>I</kbd> |
</div>
